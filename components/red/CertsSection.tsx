...
const CERTS = [
  {
    ...
    year: "2024",
    certUrl: "/certifications/AWS Certified Solutions Architect.pdf",
  },
  {
    name: "NVIDIA-Certified Associate: Generative AI & LLMs",
    issuer: "NVIDIA",
    year: "2024",
    certUrl: "/certifications/NVIDIA Certified Associate GenerativeAI LLMs.pdf",
  },
  ...
  return (
    <section id="certs" style={{ padding: "6rem 2.5rem", maxWidth: "1100px", margin: "0 auto" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: "1rem" }}>
        {CERTS.map((cert) => (
          <RedCertCard key={cert.name} {...cert} />
        ))}
      </div>
    </section>
  );
